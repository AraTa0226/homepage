...
const code = `const AudioPlanManager = () => {
                ...
                },
                {
                    ...
                    data: {
                        ...
                        options: {
                            ...
                            tweeterMountDesc: "ツィーターの角度調整と理想の定位を実現する埋込加工。"
                        }
                    }
                },
                {
                                    ...
                                    <div key={imgIdx} className="bg-black/40 border border-zinc-800 p-4 rounded-xl flex items-center gap-4 relative">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-2 py-1 text-white text-xs font-bold pr-8"
                                            />
                                        </div>
                                    </div>
                                ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pt-2">
                        ...
                        <div className="space-y-1.5">
                            ...
                            >
                                ...
                                <option value="digital_source">DSP・プレーヤー・高音質ナビ</option>
...
`;
console.log('Script file generated.');
