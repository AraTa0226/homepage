                      ...
                      <button
                        ...
                        onClick={() => {
                          const planMapping: Record<string, any> = {
                            "BASIC line (繧ｳ繧｢繧ｭ繧ｷ繝｣繝ｫ)": { id: "speaker_package", planName: "繧ｹ繝斐・繧ｫ繝ｼ莠､謠妝ASIC line・医さ繧｢繧ｭ繧ｷ繝｣繝ｫ・・ },
                            "BASIC line (繧ｻ繝代Ξ繝ｼ繝・": { id: "speaker_package", planName: "繧ｹ繝斐・繧ｫ繝ｼ莠､謠妝ASIC line・医そ繝代Ξ繝ｼ繝茨ｼ・ },
                            "STANDARD line (10荳・・縺ｾ縺ｧ)": { id: "speaker_package", planName: "繧ｹ繝斐・繧ｫ繝ｼ莠､謠婀TANDARD line・・0荳・・縺ｾ縺ｧ・・ },
                            "PREMIUM line (10荳・・莉･荳・": { id: "speaker_package", planName: "繧ｹ繝斐・繧ｫ繝ｼ莠､謠娜REMIUM line・・0荳・・莉･荳奇ｼ・ },
                            "BMW蟆ら畑繝代ャ繧ｱ繝ｼ繧ｸ": { id: "speaker_package", planName: "BMW繧ｹ繝斐・繧ｫ繝ｼ莠､謠帙ヱ繝・こ繝ｼ繧ｸ" },
                            "Mercedes Benz蟆ら畑繝代ャ繧ｱ繝ｼ繧ｸ": { id: "speaker_package", planName: "Mercedes Benz繧ｹ繝斐・繧ｫ繝ｼ莠､謠帙ヱ繝・こ繝ｼ繧ｸ" },
                            "AMP蜀・鳩DSP繝代ャ繧ｱ繝ｼ繧ｸ": { id: "digital_source", planName: "繧｢繝ｳ繝怜・阡ｵDSP繝代ャ繧ｱ繝ｼ繧ｸ" },
                            "AMP繝ｬ繧ｹDSP繝代ャ繧ｱ繝ｼ繧ｸ": { id: "digital_source", planName: "繧｢繝ｳ繝励Ξ繧ｹDSP繝代ャ繧ｱ繝ｼ繧ｸ" },
                            "縺頑焔霆ｽ菴朱浹蠅怜ｼｷ (繝代Ρ繝ｼ繝・": { id: "bass_power", planName: "繝√Η繝ｼ繝ｳ繝翫ャ繝励え繝ｼ繝輔ぃ繝ｼ繝ｻ繝代ャ繧ｱ繝ｼ繧ｸ" },
                            "縺頑焔霆ｽ菴朱浹蠅怜ｼｷ・・(繧｢繝ｳ繝怜挨)": { id: "bass_power", planName: "螟ｧ蝙九ヱ繝ｯ繝ｼ繝峨え繝ｼ繝輔ぃ繝ｼ繝ｻ繝代ャ繧ｱ繝ｼ繧ｸ" },
                            "蠎怜・縺ｮ蟶ｸ譎りｩｦ閨ｴ繝ｦ繝九ャ繝・: { id: "audition-showcase", isAnchor: true },
                            "譁ｽ蟾･繝悶Ο繧ｰ / 蠎苓・隧ｳ邏ｰ": { id: "contact", isAnchor: true }
                          };
...
function MainView({
  ...
  const audioCategories = [
    {
      id: 'speaker',
      title: '繧ｹ繝斐・繧ｫ繝ｼ繝ｻ繝代ャ繧ｱ繝ｼ繧ｸ',
      subtitle: 'ACOUSTICS',
      image: assets.audioMenuImage,
      gridClass: 'lg:row-span-2',
      items: [
        'BASIC line (繧ｳ繧｢繧ｭ繧ｷ繝｣繝ｫ)',
        'BASIC line (繧ｻ繝代Ξ繝ｼ繝・',
        'STANDARD line (10荳・・縺ｾ縺ｧ)',
        'PREMIUM line (10荳・・莉･荳・',
        '繝輔Ο繝ｳ繝・WAY繧ｻ繝・ヨ',
        'BMW蟆ら畑繝代ャ繧ｱ繝ｼ繧ｸ',
        'Mercedes Benz蟆ら畑繝代ャ繧ｱ繝ｼ繧ｸ',
        '霆顔ｨｮ蛻･繧ｹ繝斐・繧ｫ繝ｼ莠､謠帙・繝ｩ繝ｳ',
        '繝上う繧ｨ繝ｳ繝峨け繝ｩ繧ｹ繝ｻ譁ｽ蟾･'
      ],
    ...
    {
      id: 'amp',
      title: 'DSP / 繧｢繝ｳ繝・/ 繧ｦ繝ｼ繝輔ぃ繝ｼ',
      subtitle: 'ELECTRONICS',
      image: assets.auditionRoomImage,
      items: [
        'AMP蜀・鳩DSP繝代ャ繧ｱ繝ｼ繧ｸ',
        'AMP繝ｬ繧ｹDSP繝代ャ繧ｱ繝ｼ繧ｸ',
        '繧｢繝ｳ繝励う繝ｳ繧ｹ繝医・繝代ャ繧ｱ繝ｼ繧ｸ',
        '逵√せ繝壹・繧ｹ蟆丞梛繧｢繝ｳ繝・,
        '縺頑焔霆ｽ菴朱浹蠅怜ｼｷ (繝代Ρ繝ｼ繝・',
        '縺頑焔霆ｽ菴朱浹蠅怜ｼｷ・・(繧｢繝ｳ繝怜挨)',
        '繧ｵ繧､繝舌・繝翫ン繝ｻ繝励Λ繝ｳ'
      ],
      path: '/audio/amp-dsp'
    },
    {
      ...
      items: [
        '繧ｫ繧ｹ繧ｿ繝繧､繝ｳ繧ｹ繝医・繝ｫ',
        '繝・ぅ繝ｼ繧ｿ繝ｼCOOL繝槭え繝ｳ繝・,
        '繧ｪ繝ｪ繧ｸ繝翫Ν繧｢繧ｦ繧ｿ繝ｼ繝舌ャ繝輔Ν',
        '繧ｵ繝悶え繝ｼ繝上・譁ｽ蟾･縺ｮ繧｢繝ｬ繧ｳ繝ｬ',
        '繝倥ャ繝峨Θ繝九ャ繝・/ 繝励Ο繧ｻ繝・し繝ｼ'
      ],
      path: '/audio/custom'
    },
    {
      id: 'tech',
      title: '繝上う繝ｬ繧ｾ繝ｻ繝・ず繧ｿ繝ｫ',
      subtitle: 'TECH & DIGITAL',
      image: assets.showroomImage,
      items: [
        '繝上う繝ｬ繧ｾ蟆主・縺ｮ繧ｹ繧ｹ繝｡',
        '縺・∪豕ｨ逶ｮ・√Γ繝・ぅ繧｢繝励Ξ繝ｼ繝､繝ｼ',
        '繝・ず繧ｿ繝ｫ繧ｽ繝ｼ繧ｹ繝ｻ繝薙Ν繝峨い繝・・'
      ],
      path: '/audio/digital-source'
    },
    {
      id: 'deadening',
      title: '繝・ャ繝峨ル繝ｳ繧ｰ繝ｻ髻ｳ髻ｿ繝代・繝・,
      subtitle: 'DEADENING',
      image: assets.pitImage,
      items: [
        '繝峨い繝√Η繝ｼ繝九Φ繧ｰ (繝・ャ繝峨ル繝ｳ繧ｰ)',
        '繧ｵ繧､繝ｬ繝ｳ繝医メ繝･繝ｼ繝九Φ繧ｰ (髱咎浹)',
        '髮ｻ貅仙ｼｷ蛹・/ 繝舌ャ逶ｴ譁ｽ蟾･'
      ],
          ...
          >
            ...
            >
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <h3 className="text-2xl font-black tracking-tighter text-gray-900">邂｡逅・・ｪ崎ｨｼ</h3>
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-4">
                <div className="relative">
                  ...
                  />
                  {passwordError && (
                    <p className="text-red-500 text-[10px] font-bold uppercase tracking-widest mt-2">繝代せ繝ｯ繝ｼ繝峨′豁｣縺励￥縺ゅｊ縺ｾ縺帙ｓ</p>
                  )}
                </div>
                <button
                  type="submit"
        ...
        <div className="max-w-7xl mx-auto px-4 h-16 md:h-24 flex items-center gap-2">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm font-bold uppercase tracking-widest shrink-0">
            <a href="#" className="flex flex-col items-center group/item transition-colors">
              ...
              <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">繝帙・繝</span>
            </a>
            <a href="#blog" className="flex flex-col items-center group/item transition-colors">
              ...
              <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">繝悶Ο繧ｰ</span>
            </a>
            <div
            ...
            >
              ...
              >
                ...
                <span className="text-[8px] font-bold opacity-40 group-hover/nav:opacity-100 transition-opacity">繝励Λ繝ｳ荳隕ｧ</span>
              </button>
            </div>
            <a href="#options" className="flex flex-col items-center group/item transition-colors">
              ...
              <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">隧ｦ閨ｴ繧ｹ繝斐・繧ｫ繝ｼ</span>
            </a>
            <a href="#partners" className="flex flex-col items-center group/item transition-colors">
              ...
              <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">蜿匁桶繝悶Λ繝ｳ繝・/span>
            </a>
            <a href="#info" className="flex flex-col items-center group/item transition-colors">
              ...
              <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">蝟ｶ讌ｭ譌･</span>
            </a>
            <div
            ...
            >
              ...
              >
                ...
                <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">繝励Λ繝ｳ荳隕ｧ</span>
              </a>
              <MegaMenu
                show={showMegaMenu}
            ...
            <a href="#access" className="flex flex-col items-center group/item transition-colors">
              ...
              <span className="text-[8px] font-bold opacity-40 group-hover/item:opacity-100 transition-opacity">蠎苓・譯亥・</span>
            </a>
          </nav>
            ...
            >
              ...
              <div className="flex-grow overflow-y-auto p-6">
                <nav className="flex flex-col gap-3">
                  {[
                    { href: "#", en: "HOME", jp: "繝帙・繝" },
                    { href: "#blog", en: "BLOG", jp: "繝悶Ο繧ｰ" },
                    { href: "#services", en: "LINEUP", jp: "繝励Λ繝ｳ荳隕ｧ", isExpandable: true },
                    { href: "#options", en: "AUDITION", jp: "隧ｦ閨ｴ繧ｹ繝斐・繧ｫ繝ｼ" },
                    { href: "#partners", en: "BRANDS", jp: "蜿匁桶繝悶Λ繝ｳ繝・ },
                    { href: "#info", en: "SCHEDULE", jp: "蝟ｶ讌ｭ譌･" },
                    { href: "#access", en: "ACCESS", jp: "蠎苓・譯亥・" },
                  ].map((link, i) => {
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-32 md:py-40">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <h1 className="text-3xl md:text-7xl font-black text-white mb-8 leading-[1.2] md:leading-[1.1] tracking-tighter">
              ...
              <span className="block md:inline whitespace-nowrap">繧ｵ繧ｦ繝ｳ繝峨お繝翫ず繝ｼ</span>
            </h1>
            ...
            <p className="text-base md:text-2xl text-gray-200 mb-8 font-bold leading-relaxed max-w-3xl">
              髻ｳ繧呈･ｵ繧√・浹讌ｽ縺ｮ逵滄ｫ・ｒ螻翫￠邯壹￠縺ｦ30蟷ｴ莉･荳翫・br className="hidden md:block" />
              蝗ｽ蜀・ｱ域欠縺ｮ謚陦薙ｒ隱・ｋ繝上う繧ｨ繝ｳ繝峨・繧ｪ繝ｼ繝・ぅ繧ｪ縺ｮ郢顔ｴｰ縺ｪ隱ｿ髻ｳ縺ｨ譁ｽ蟾･縲・br className="hidden md:block" />
              辭溽ｷｴ縺ｮ閨ｷ莠ｺ謚縺ｧ縲√≠縺ｪ縺溘・繧ｫ繝ｼ繝ｩ繧､繝輔↓遨ｶ讌ｵ縺ｮ諢溷虚繧偵・            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl md:text-5xl font-black leading-tight tracking-tighter">繝悶Ο繧ｰ</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 text-center md:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-black leading-tight tracking-tighter mb-4">
              {isSecurityDomain ? 'SECURITY CATALOG' : '繧ｪ繝ｼ繝・ぅ繧ｪ繝ｻ繝ｩ繧､繝ｳ繝翫ャ繝・}
            </h2>
            <p className={`text-sm font-bold uppercase tracking-[0.2em] opacity-40 ${theme === 'dark' ? 'text-emerald-400' : 'text-blue-600'}`}>
              {isSecurityDomain ? 'Vault Grade Protection for Your Assets' : '譛鬮倥・髻ｳ髻ｿ遨ｺ髢薙ｒ縺吶∋縺ｦ縺ｮ莠ｺ縺ｫ'}
            </p>
          </div>
          ...
          <div id="access" className="grid lg:grid-cols-2 gap-12 items-start bg-white/5 p-8 md:p-12 rounded-[3rem] border border-white/10">
            ...
            <div className="lg:sticky lg:top-32 space-y-8">
              <div>
                ...
                <h2 className="text-3xl font-black text-white mb-6 tracking-tighter">蠎苓・譯亥・</h2>
