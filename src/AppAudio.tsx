...
import { PriceProvider, usePrices, formatPrice } from './contexts/PriceContext';
...
function AppContent() {
  ...
  const { emergencyAnnouncement, plans } = usePrices();
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-orange-500 selection:text-white">
      ...
      <section className="relative pt-20">
        ...
        <div className="max-w-5xl mx-auto px-4 -mb-20 relative z-20">
          <div className="bg-white rounded-2xl p-8 grid grid-cols-1 md:grid-cols-2 gap-6 shadow-2xl border border-gray-200">
            <button
            ...
            >
              ...
              <span className="font-bold text-sm text-gray-600 uppercase tracking-widest group-hover:text-blue-600 transition-colors">Partners</span>
            </button>
          </div>
        </div>
      </section>
