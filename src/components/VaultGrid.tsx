                                        ...
                                        <div className="grid grid-cols-1 gap-2">
                                            {group.items.map((item: string, j: number) => (
                                                <div
                                                    ...
                                                    className={`flex items-center justify-between text-[11px] md:text-xs font-bold px-4 py-2.5 rounded-xl border transition-all hover:translate-x-1 ${theme === 'dark'
                                                        ...
                                                        } ${item.includes('相談') ? 'bg-emerald-50/50 border-emerald-100 text-emerald-700' : ''}`}
                                                >
