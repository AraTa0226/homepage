                ...
                <div className="max-w-5xl mx-auto bg-black border border-purple-500/20 p-12 md:p-24 rounded-[5rem] relative z-10 text-center space-y-12">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-center items-center pt-8">
                        <button
                            ...
                            className="w-full md:w-auto px-12 py-5 bg-purple-500 text-black font-black italic tracking-tighter rounded-full text-lg hover:scale-105 transition-all flex items-center justify-center gap-3 group"
                        >
                            対策製品を見る
